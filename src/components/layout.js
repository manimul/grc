...
function Layout({ children }) {
  return (
    <div className="flex flex-col min-h-screen font-sans text-gray-900 ">
      ...
      <main className="flex-1 w-full  mx-auto  pt-24">
        {children}
      </main>
      ...
      <section className="[contact] grid grid-cols-2 gap-4 ">
        ...
        <div className="p-24">
          ...
          <p className="inline-block text-4xl font-bold mb-4 leading-tight">Please get in touch if you have any questions or would like to work with us</p>

<p className="mb-4">We are always looking for exciting partnership prospects and we are equally enthuastic to discuss our concept with interested parties. 
  ...
  <div className="md:flex md:items-center">
    ...
    <div className="md:w-2/3"></div>
      ...
      <footer className="bg-grc-navy ">
        ...
        <p className="py-4 pr-4">Our River Center concept combines in-demand services in a sustainable commercial business model. </p>
        <div className="[social_icons] inline-flex ">
        <img className="w-1/4 pr-2 " src="https://via.placeholder.com/32x32"/>
        <img className="w-1/4 pr-2" src="https://via.placeholder.com/32x32"/>
        <img className="w-1/4 pr-2" src="https://via.placeholder.com/32x32"/>
        <img className="w-1/4 pr-2" src="https://via.placeholder.com/32x32"/>
        </div>
        ...
        <nav className="pb-8">
          ...
          <ul>
            <li className="pb-1 opacity-75 hover:opacity-100 cursor-pointer"><a href="#">The Problem</a></li>
            <li className="pb-1 opacity-75 hover:opacity-100 cursor-pointer"><a href="#">The Problem</a></li>
            <li className="pb-1 opacity-75 hover:opacity-100 cursor-pointer"><a href="#">The Problem</a></li>
            <li className="pb-1 opacity-75 hover:opacity-100 cursor-pointer"><a href="#">The Problem</a></li>
        ...
        <p className="py-6 text-sm">
          Global River Center Ap/s 2020 | CVR: 40882669             
        </p>
        </div>
      </footer>
    </div>
