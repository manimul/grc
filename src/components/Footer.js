  ...
  return (
    <div>
      <footer className='bg-grc-navy '>
        <div className='p-12  text-center md:text-left md:p-12 flex flex-wrap justify-between max-w-6xl  mx-auto text-white text-sm md:py-24'>
          <div className=' w-full md:w-1/4 md:pr-12 '>
            ...
            <div className='[social_icons] flex '>
              <a
                href='https://facebook.com/globalrivercenter'
                className='md:w-1/6 md:pr-2 text-white'
              >
                <svg
                  role='img'
                  viewBox='0 0 24 24'
              ...
              <a
                href='https://instagram.com/globalrivercenter'
                className='md:w-1/6 md:pr-2 text-white'
              >
                <svg
                  role='img'
              ...
              <a
                href='https://linkedin.com/company/globalrivercenter'
                className='md:w-1/6 md:pr-2 text-white'
              >
                <svg
                  role='img'
              ...
              <a
                href='https://twitter.com/rivercentr'
                className='md:w-1/6 md:pr-2 text-white'
              >
                <svg
                  role='img'
          ...
          <div className='w-1/2 md:w-1/4'>
            <nav className='pb-8'>
              <h1 className='font-bold pb-2'>Learn About GRC</h1>
              <ul>
                <li className='pb-1 opacity-75 hover:opacity-100 cursor-pointer'>
                  <Link to='/story'>Our Story</Link>
                </li>
                <li className='pb-1 opacity-75 hover:opacity-100 cursor-pointer'>
                  <Link to='/story#our-vision'>Our Vision</Link>
                </li>
                <li className='pb-1 opacity-75 hover:opacity-100 cursor-pointer'>
                  <Link to='/story#the-need'>The Need</Link>
                </li>
                <li className='pb-1 opacity-75 hover:opacity-100 cursor-pointer'>
                  <Link to='/story#faq'>FAQ</Link>
                </li>
              </ul>
            </nav>

            <nav className='pb-8'>
              <h1 className='font-bold pb-2'>What GRC does</h1>
              <ul>
                <li className='pb-1 opacity-75 hover:opacity-100 cursor-pointer'>
          ...
          <div className='w-1/2 md:w-1/4'>
            <nav className='pb-8'>
              <h1 className='font-bold pb-2'>The People</h1>
              <ul>
                <li className='pb-1 opacity-75 hover:opacity-100 cursor-pointer'>
            ...
            <nav className='pb-8'>
              <h1 className='font-bold pb-2'>Misc</h1>
              <ul>
                <li className='pb-1 opacity-75 hover:opacity-100 cursor-pointer'>
